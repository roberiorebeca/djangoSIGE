...
DEFAULT_DATABASE_URL = 'postgres://postgres:legisapoio123qwE@localhost:5432/djangosige_db'
...
#
DEFAULT_FROM_EMAIL = 'sige.grsistemas@gmail.com'

EMAIL_HOST = 'smtp.gmail.com'  # Gmail
# EMAIL_HOST = 'smtp.live.com' #Hotmail

# Usuário do email padrão
EMAIL_HOST_USER = 'sige.grsistemas@gmail.com'

# Senha do email padrão
EMAIL_HOST_PASSWORD = 'Sige762374$@'
