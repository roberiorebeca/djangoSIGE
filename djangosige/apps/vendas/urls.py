...
urlpatterns = [
    ...
    re_path(r'orcamentovenda/listaorcamentovenda/hoje/$',
    ...
    re_path(r'pagamento/adicionar/$', views.AdicionarCondicaoPagamentoView.as_view(),
    ...
    re_path(r'pagamento/editar/(?P<pk>[0-9]+)/$', views.EditarCondicaoPagamentoView.as_view(
    ), name='editarcondicaopagamentoview'),

    # Request ajax views
    re_path(r'infocondpagamento/$', views.InfoCondicaoPagamento.as_view(),
        name='infocondpagamento'),
    re_path(r'infovenda/$', views.InfoVenda.as_view(), name='infovenda'),

    # Gerar pdf orcamento
    re_path(r'gerarpdforcamentovenda/(?P<pk>[0-9]+)/$',
    ...
    re_path(r'copiarorcamentovenda/(?P<pk>[0-9]+)/$',
    ...
    re_path(r'cancelarorcamentovenda/(?P<pk>[0-9]+)/$',
